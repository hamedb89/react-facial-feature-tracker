...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _pubsubJs = __webpack_require__(36);
	...
	var Demo = function (_React$Component) {
		...
		function Demo(props) {
			...
			_pubsubJs2.default.subscribe('emotions.loop', function (e, emotions) {
				...
				var color = 'rgb(' + Math.floor(255 * emotions[0].value) + ', ' + Math.floor(255 * emotions[1].value) + ', ' + Math.floor(255 * emotions[3].value) + ')';
		...
		_createClass(Demo, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(this.props.facialFeatureTracker, { PubSub: _pubsubJs2.default }),
